...
<template>
  <div class="edit-info_box">
    ...
    <div mb-16 mt-6 flex justify-center relative>
      ...
      <van-image round h-7 w-7 bottom-0 right-36 absolute :src="upImg" fit="cover" @click="clickElement" />
    </div>

    <div px-layout-padding>
      <div ai-input-title style="margin-bottom: 16px;">Name</div>
      <van-field v-model="formData.name" placeholder="Please enter" class="public-input" />
    </div>

    <div px-layout-padding pt-6>
      <div ai-input-title style="margin-bottom: 16px;">About me</div>
      <van-field v-model="formData.about" placeholder="Please enter" class="public-input" />
    </div>
